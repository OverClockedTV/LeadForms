    ...
    angular.module("mgcrea.ngStrap", ["mgcrea.ngStrap.modal", "mgcrea.ngStrap.aside", "mgcrea.ngStrap.alert", "mgcrea.ngStrap.button", "mgcrea.ngStrap.select", "mgcrea.ngStrap.datepicker", "mgcrea.ngStrap.timepicker", "mgcrea.ngStrap.navbar", "mgcrea.ngStrap.tooltip", "mgcrea.ngStrap.popover", "mgcrea.ngStrap.dropdown", "mgcrea.ngStrap.typeahead", "mgcrea.ngStrap.scrollspy", "mgcrea.ngStrap.affix", "mgcrea.ngStrap.tab"]), angular.module("mgcrea.ngStrap.affix", ["mgcrea.ngStrap.helpers.dimensions"]).provider("$affix",function () {
        ...
        this.$get = ["$window", "dimensions", function (b, c) {
            function d(d, f) {
                ...
                var t = 0;
                k.offsetTop && ("auto" === k.offsetTop && (k.offsetTop = "+0"), k.offsetTop.match(/^[-+]\d+$/) ? (n -= 1 * k.offsetTop, t = k.offsetParent ? c.offset(r[0]).top + 1 * k.offsetTop : c.offset(d[0]).top - c.css(d[0], "marginTop", !0) + 1 * k.offsetTop) : t = 1 * k.offsetTop);
                var u = 0;
                return k.offsetBottom && (u = k.offsetParent && k.offsetBottom.match(/^[-+]\d+$/) ? i() - (c.offset(r[0]).top + c.height(r[0])) + 1 * k.offsetBottom + 1 : 1 * k.offsetBottom), j.init = function () {
                    o = c.offset(d[0]).top + n, l.on("scroll", this.checkPosition), l.on("click", this.checkPositionWithEventLoop), this.checkPosition(), this.checkPositionWithEventLoop()
                }, j.destroy = function () {
                    ...
                    p !== i && (p = i, d.removeClass(m).addClass("affix" + ("middle" !== i ? "-" + i : "")), "top" === i ? (q = null, d.css("position", k.offsetParent ? "" : "relative"), d.css("top", "")) : "bottom" === i ? (q = k.offsetUnpin ? -(1 * k.offsetUnpin) : b.top - a, d.css("position", k.offsetParent ? "" : "relative"), d.css("top", k.offsetParent ? "" : e[0].offsetHeight - u - f - o + "px")) : (q = null, d.css("position", "fixed"), d.css("top", n + "px")))
                }, j.init(), j
            }
            ...
            return{restrict: "EAC", require: "^?bsAffixTarget", link: function (c, d, e, f) {
                var g = {scope: c, offsetTop: "auto", target: f ? f.$element : angular.element(b)};
        ...
        var a = this.defaults = {animation: "am-fade", prefixClass: "alert", placement: null, template: "alert/alert.tpl.html", container: !1, element: null, backdrop: !1, keyboard: !0, show: !0, duration: !1, type: !1};
        this.$get = ["$modal", "$timeout", function (b, c) {
            ...
            return{restrict: "EAC", scope: !0, link: function (a, b, e) {
        ...
        var a = this.defaults = {animation: "am-fade-and-slide-right", prefixClass: "aside", placement: "right", template: "aside/aside.tpl.html", contentTemplate: !1, container: !1, element: null, backdrop: !0, keyboard: !0, html: !1, show: !0};
        ...
        return{restrict: "A", require: "ngModel", compile: function (a, b) {
            ...
            return{restrict: "A", require: "ngModel", link: function (a, e, f, g) {
        ...
        var a = this.defaults = {animation: "am-fade", prefixClass: "datepicker", placement: "bottom-left", template: "datepicker/datepicker.tpl.html", trigger: "focus", container: !1, keyboard: !0, html: !1, delay: 0, useNative: !1, dateType: "date", dateFormat: "shortDate", autoclose: !1, minDate: -1 / 0, maxDate: +1 / 0, startView: 0, minView: 0, startWeek: 0};
        this.$get = ["$window", "$document", "$rootScope", "$sce", "$locale", "dateFilter", "datepickerViews", "$tooltip", function (b, c, d, e, f, g, h, i) {
            function j(b, c, d) {
                ...
                n.$select = function (a) {
                    ...
                    angular.isDate(c.$dateValue) || (c.$dateValue = new Date(a)), c.$dateValue.setFullYear(a.getFullYear(), a.getMonth(), a.getDate()), !n.$mode || b ? (c.$setViewValue(c.$dateValue), c.$render(), m.autoclose && !b && g.hide(!0)) : (angular.extend(p, {year: a.getFullYear(), month: a.getMonth(), date: a.getDate()}), g.setMode(n.$mode - 1), g.$build())
                    ...
                    angular.extend(p, {year: c.getUTCFullYear(), month: c.getUTCMonth(), date: c.getUTCDate()}), g.$build()
                ...
                var r = g.init;
                g.init = function () {
                    return l && m.useNative ? (b.prop("type", "date"), void b.css("-webkit-appearance", "textfield")) : (k && (b.prop("type", "text"), b.attr("readonly", "true"), b.on("click", f)), void r())
                };
                var s = g.destroy;
                g.destroy = function () {
                ...
                return g.hide = function (a) {
                    g.$element.off(k ? "touchstart" : "mousedown", g.$onMouseDown), m.keyboard && b.off("keydown", g.$onKeyDown), u(a)
                }, g
            }
        ...
        this.$get = ["$locale", "$sce", "dateFilter", function (b, c, d) {
            return function (e) {
                var f = e.$scope, g = e.$options, h = b.DATETIME_FORMATS.SHORTDAY, i = h.slice(g.startWeek).concat(h.slice(0, g.startWeek)), j = c.trustAsHtml('<th class="dow text-center">' + i.join('</th><th class="dow text-center">') + "</th>"), k = e.$date || new Date, l = {year: k.getFullYear(), month: k.getMonth(), date: k.getDate()}, m = (6e4 * k.getTimezoneOffset(), [
                    {format: "dd", split: 7, steps: {month: 1}, update: function (a, b) {
                        !this.built || b || a.getFullYear() !== l.year || a.getMonth() !== l.month ? (angular.extend(l, {year: e.$date.getFullYear(), month: e.$date.getMonth(), date: e.$date.getDate()}), e.$build()) : a.getDate() !== l.date && (l.date = e.$date.getDate(), e.$updateSelected())
                    }, build: function () {
                        for (var b, c = new Date(l.year, l.month, 1), h = new Date(+c - 864e5 * (c.getDay() + g.startWeek)), i = [], k = 0; 42 > k; k++)b = new Date(h.getFullYear(), h.getMonth(), h.getDate() + k), i.push({date: b, label: d(b, this.format), selected: e.$date && this.isSelected(b), muted: b.getMonth() !== l.month, disabled: this.isDisabled(b)});
                    ...
                    {name: "month", format: "MMM", split: 4, steps: {year: 1}, update: function (a) {
                        this.built && a.getFullYear() === l.year ? a.getMonth() !== l.month && (angular.extend(l, {month: e.$date.getMonth(), date: e.$date.getDate()}), e.$updateSelected()) : (angular.extend(l, {year: e.$date.getFullYear(), month: e.$date.getMonth(), date: e.$date.getDate()}), e.$build())
                    }, build: function () {
                        for (var b, c = (new Date(l.year, 0, 1), []), g = 0; 12 > g; g++)b = new Date(l.year, g, 1), c.push({date: b, label: d(b, this.format), selected: e.$isSelected(b), disabled: this.isDisabled(b)});
                    ...
                    {name: "year", format: "yyyy", split: 4, steps: {year: 12}, update: function (a, b) {
                        !this.built || b || parseInt(a.getFullYear() / 20, 10) !== parseInt(l.year / 20, 10) ? (angular.extend(l, {year: e.$date.getFullYear(), month: e.$date.getMonth(), date: e.$date.getDate()}), e.$build()) : a.getFullYear() !== l.year && (angular.extend(l, {year: e.$date.getFullYear(), month: e.$date.getMonth(), date: e.$date.getDate()}), e.$updateSelected())
                    }, build: function () {
                        for (var b, c = l.year - l.year % (3 * this.split), g = [], h = 0; 12 > h; h++)b = new Date(c + h, 0, 1), g.push({date: b, label: d(b, this.format), selected: e.$isSelected(b), disabled: this.isDisabled(b)});
                        f.title = g[0].label + "-" + g[g.length - 1].label, f.labels = !1, f.rows = a(g, this.split), this.built = !0
                    }, isSelected: function (a) {
        ...
        var a = this.defaults = {animation: "am-fade", prefixClass: "dropdown", placement: "bottom-left", template: "dropdown/dropdown.tpl.html", trigger: "click", container: !1, keyboard: !0, html: !1, delay: 0};
        ...
        var a = Date.prototype, b = this.defaults = {format: "shortDate", strict: !1};
        this.$get = ["$locale", function (c) {
            var d = function (d) {
                ...
                var h, i, j = angular.extend({}, b, d), k = {}, l = {sss: "[0-9]{3}", ss: "[0-5][0-9]", s: j.strict ? "[1-5]?[0-9]" : "[0-5][0-9]", mm: "[0-5][0-9]", m: j.strict ? "[1-5]?[0-9]" : "[0-5][0-9]", HH: "[01][0-9]|2[0-3]", H: j.strict ? "[0][1-9]|[1][012]" : "[01][0-9]|2[0-3]", hh: "[0][1-9]|[1][012]", h: j.strict ? "[1-9]|[1][012]" : "[0]?[1-9]|[1][012]", a: "AM|PM", EEEE: c.DATETIME_FORMATS.DAY.join("|"), EEE: c.DATETIME_FORMATS.SHORTDAY.join("|"), dd: "[0-2][0-9]{1}|[3][01]{1}", d: j.strict ? "[1-2]?[0-9]{1}|[3][01]{1}" : "[0-2][0-9]{1}|[3][01]{1}", MMMM: c.DATETIME_FORMATS.MONTH.join("|"), MMM: c.DATETIME_FORMATS.SHORTMONTH.join("|"), MM: "[0][1-9]|[1][012]", M: j.strict ? "[1-9]|[1][012]" : "[0][1-9]|[1][012]", yyyy: "(?:(?:[1]{1}[0-9]{1}[0-9]{1}[0-9]{1})|(?:[2]{1}[0-9]{3}))(?![[0-9]])", yy: "(?:(?:[0-9]{1}[0-9]{1}))(?![[0-9]])"}, m = {sss: a.setMilliseconds, ss: a.setSeconds, s: a.setSeconds, mm: a.setMinutes, m: a.setMinutes, HH: a.setHours, H: a.setHours, hh: a.setHours, h: a.setHours, dd: a.setDate, d: a.setDate, a: function (a) {
                    var b = this.getHours();
                    ...
                    return this.setMonth(1 * a - 1)
                }, yyyy: a.setFullYear, yy: function (a) {
            ...
            function d(d, e) {
                function f(a) {
                    return a.map(function (a, b) {
                        var c, d, e = {};
                        return e[k] = a, c = j(e), d = n(e) || b, {label: c, value: d}
                    })
                }
        ...
        var a = this.defaults = {animation: "am-fade", backdropAnimation: "am-fade", prefixClass: "modal", placement: "top", template: "modal/modal.tpl.html", contentTemplate: !1, container: !1, element: null, backdrop: !0, keyboard: !0, html: !1, show: !0};
        this.$get = ["$window", "$rootScope", "$compile", "$q", "$templateCache", "$http", "$animate", "$timeout", "dimensions", function (c, d, e, f, g, h, i) {
            function j(b) {
                ...
                return f.$promise.then(function (a) {
                    angular.isObject(a) && (a = a.data), g.html && (a = a.replace(q, 'ng-bind-html="')), a = n.apply(a), j = e(a), f.init()
                }), f.init = function () {
                    ...
                    }), r.css({display: "block"}).addClass(g.placement), g.animation && (g.backdrop && s.addClass(g.backdropAnimation), r.addClass(g.animation)), g.backdrop && i.enter(s, p, null, function () {
                    }), i.enter(r, a, b, function () {
                    }), h.$isShown = !0, h.$$phase || h.$digest();
                    var d = r[0];
                    o(function () {
                        d.focus()
                    }), p.addClass(g.prefixClass + "-open"), g.backdrop && (r.on("click", c), s.on("click", c)), g.keyboard && r.on("keyup", f.$onKeyUp)
                }, f.hide = function () {
                    i.leave(r, function () {
                        p.removeClass(g.prefixClass + "-open")
                    }), g.backdrop && i.leave(s, function () {
                    }), h.$isShown = !1, h.$$phase || h.$digest(), g.backdrop && (r.off("click", c), s.off("click", c)), g.keyboard && r.off("keyup", f.$onKeyUp)
                }, f.toggle = function () {
        ...
        var a = this.defaults = {animation: "am-fade", placement: "right", template: "popover/popover.tpl.html", contentTemplate: !1, trigger: "click", keyboard: !0, html: !1, title: "", content: "", delay: 0, container: !1};
        this.$get = ["$tooltip", function (b) {
            ...
            return{restrict: "EAC", scope: !0, link: function (a, b, f) {
                var g = {scope: a};
        ...
        var a = this.defaults = {animation: "am-fade", prefixClass: "select", placement: "bottom-left", template: "select/select.tpl.html", trigger: "focus", container: !1, keyboard: !0, html: !1, delay: 0, multiple: !1, sort: !0, caretHtml: '&nbsp;<span class="caret"></span>', placeholder: "Choose among the following..."};
        ...
        var a = this.defaults = {animation: "am-fade", prefixClass: "timepicker", placement: "bottom-left", template: "timepicker/timepicker.tpl.html", trigger: "focus", container: !1, keyboard: !0, html: !1, delay: 0, useNative: !0, timeType: "date", timeFormat: "shortTime", autoclose: !1, minTime: -1 / 0, maxTime: +1 / 0, length: 5, hourStep: 1, minuteStep: 5};
        this.$get = ["$window", "$document", "$rootScope", "$sce", "$locale", "dateFilter", "$tooltip", function (b, c, d, e, f, g, h) {
            function i(b, c, d) {
                ...
                var l = h(b, angular.extend({}, a, d)), m = d.scope, n = l.$options, o = l.$scope, p = 0, q = c.$dateValue || new Date, r = {hour: q.getHours(), meridian: q.getHours() < 12, minute: q.getMinutes(), second: q.getSeconds(), millisecond: q.getMilliseconds()}, s = f.DATETIME_FORMATS[n.timeFormat] || n.timeFormat, t = /(h+)[:]?(m+)[ ]?(a?)/i.exec(s).slice(1);
                o.$select = function (a, b) {
                    ...
                    angular.isDate(a) && !isNaN(a.getTime()) ? (l.$date = a, angular.extend(r, {hour: a.getHours(), minute: a.getMinutes(), second: a.getSeconds(), millisecond: a.getMilliseconds()}), l.$build()) : l.$isBuilt || l.$build()
                }, l.select = function (a, b, d) {
                    isNaN(c.$dateValue.getTime()) && (c.$dateValue = new Date(1970, 0, 1)), angular.isDate(a) || (a = new Date(a)), 0 === b ? c.$dateValue.setHours(a.getHours()) : 1 === b && c.$dateValue.setMinutes(a.getMinutes()), c.$setViewValue(c.$dateValue), c.$render(), n.autoclose && !d && l.hide(!0)
                    ...
                    for (a = 0; a < n.length; a++)b = new Date(1970, 0, 1, r.hour - (c - a) * n.hourStep), d.push({date: b, label: g(b, t[0]), selected: l.$date && l.$isSelected(b, 0), disabled: l.$isDisabled(b, 0)});
                    var e, f = [];
                    for (a = 0; a < n.length; a++)e = new Date(1970, 0, 1, 0, r.minute - (c - a) * n.minuteStep), f.push({date: e, label: g(e, t[1]), selected: l.$date && l.$isSelected(e, 1), disabled: l.$isDisabled(e, 1)});
                    var h = [];
                    for (a = 0; a < n.length; a++)h.push([d[a], f[a]]);
                    o.rows = h, o.showAM = !!t[2], o.isAM = (l.$date || d[c].date).getHours() < 12, l.$isBuilt = !0
                    ...
                    var c;
                    return 0 === b ? c = a.getTime() + 6e4 * r.minute : 1 === b && (c = a.getTime() + 36e5 * r.hour), c < n.minTime || c > n.maxTime
                }, l.$moveIndex = function (a, b) {
                    var c;
                    0 === b ? (c = new Date(1970, 0, 1, r.hour + a * n.length, r.minute), angular.extend(r, {hour: c.getHours()})) : 1 === b && (c = new Date(1970, 0, 1, r.hour, r.minute + a * n.length * 5), angular.extend(r, {minute: c.getMinutes()})), l.$build()
                    ...
                    if (/(38|37|39|40|13)/.test(a.keyCode) && !a.shiftKey && !a.altKey) {
                        ...
                        if (i && (37 === a.keyCode ? p = 1 > p ? j - 1 : p - 1 : 39 === a.keyCode && (p = j - 1 > p ? p + 1 : 0)), 0 === p) {
                            if (i)return e(0, d);
                ...
                var u = l.init;
                l.init = function () {
                    return k && n.useNative ? (b.prop("type", "time"), void b.css("-webkit-appearance", "textfield")) : (j && (b.prop("type", "text"), b.attr("readonly", "true"), b.on("click", i)), void u())
                };
                var v = l.destroy;
                l.destroy = function () {
                ...
                return l.hide = function (a) {
                    l.$element.off(j ? "touchstart" : "mousedown", l.$onMouseDown), n.keyboard && b.off("keydown", l.$onKeyDown), x(a)
                }, l
            }
            ...
            return{restrict: "EAC", require: "ngModel", link: function (a, b, c, d) {
                ...
                angular.forEach(["minTime", "maxTime"], function (a) {
                    angular.isDefined(c[a]) && c.$observe(a, function (b) {
                        j.$options[a] = "now" === b ? (new Date).setFullYear(1970, 0, 1) : angular.isString(b) && b.match(/^".+"$/) ? +new Date(b.substr(1, b.length - 2)) : k.parse(b), !isNaN(j.$options[a]) && j.$build()
                    })
                }), a.$watch(c.ngModel, function () {
                    j.update(d.$dateValue)
        ...
        var a = this.defaults = {animation: "am-fade", prefixClass: "tooltip", container: !1, placement: "top", template: "tooltip/tooltip.tpl.html", contentTemplate: !1, trigger: "hover focus", keyboard: !1, html: !1, show: !1, title: "", type: "", delay: 0};
        this.$get = ["$window", "$rootScope", "$compile", "$q", "$templateCache", "$http", "$animate", "$timeout", "dimensions", "$$animateReflow", function (c, d, e, f, g, h, i, j, k, l) {
            function m(b, c) {
                ...
                j.delay && angular.isString(j.delay) && (j.delay = parseFloat(j.delay)), j.title && (h.$scope.title = j.title), m.$hide = function () {
                ...
                return h.$promise.then(function (a) {
                    angular.isObject(a) && (a = a.data), j.html && (a = a.replace(q, 'ng-bind-html="')), a = p.apply(a), v = a, t = e(a), h.init()
                }), h.init = function () {
                    j.delay && angular.isNumber(j.delay) && (j.delay = {show: j.delay, hide: j.delay}), "self" === j.container ? w = b : j.container && (w = n(j.container));
                    var a = j.trigger.split(" ");
                    angular.forEach(a, function (a) {
                        "click" === a ? b.on("click", h.toggle) : "manual" !== a && (b.on("hover" === a ? "mouseenter" : "focus", h.enter), b.on("hover" === a ? "mouseleave" : "blur", h.leave))
                    ...
                    for (var a = j.trigger.split(" "), c = a.length; c--;) {
                        var d = a[c];
                        "click" === d ? b.off("click", h.toggle) : "manual" !== d && (b.off("hover" === d ? "mouseenter" : "focus", h.enter), b.off("hover" === d ? "mouseleave" : "blur", h.leave))
                    }
                    ...
                    u && u.remove(), u = h.$element = t(m, function () {
                    }), u.css({top: "0px", left: "0px", display: "block"}).addClass(j.placement), j.animation && u.addClass(j.animation), j.type && u.addClass(j.prefixClass + "-" + j.type), i.enter(u, a, c, function () {
                    }), h.$isShown = !0, m.$$phase || m.$digest(), l(h.$applyPlacement), j.keyboard && ("focus" !== j.trigger ? (h.focus(), u.on("keyup", h.$onKeyUp)) : b.on("keyup", h.$onFocusKeyUp))
                }, h.leave = function () {
                    ...
                    return h.$isShown ? (i.leave(u, function () {
                        u = null
                    }), m.$$phase || m.$digest(), h.$isShown = !1, j.keyboard && u.off("keyup", h.$onKeyUp), a && "focus" === j.trigger ? b[0].blur() : void 0) : void 0
                }, h.toggle = function () {
        ...
        var a = this.defaults = {animation: "am-fade", prefixClass: "typeahead", placement: "bottom-left", template: "typeahead/typeahead.tpl.html", trigger: "focus", container: !1, keyboard: !0, html: !1, delay: 0, minLength: 1, limit: 6};
